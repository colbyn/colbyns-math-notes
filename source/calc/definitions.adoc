...
Then there must exist some value of stem:[x] for which:
...
image::https://upload.wikimedia.org/wikipedia/commons/thumb/e/ee/Mvt2.svg/520px-Mvt2.svg.png[]
...
image::https://upload.wikimedia.org/wikipedia/commons/9/94/Mittelwertsatz3.svg[]

It is also possible that there are multiple tangents parallel to the secant:

image::https://upload.wikimedia.org/wikipedia/commons/f/f9/Mittelwertsatz6.svg[]
====
