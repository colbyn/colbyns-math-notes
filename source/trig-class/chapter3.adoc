...
\begin{equation}
\begin{split}
\sin \circ \arcsin \triangleleft x &= x
\cos \circ \arccos \triangleleft x &= x
\end{split}
\end{equation}
++++

If stem:[x] is any real number, then:
[latexmath]
++++
\begin{equation}
\begin{split}
\tan \circ \arctan \triangleleft x &= x
\end{split}
\end{equation}
++++

If stem:[-\frac{\pi}{2} \leq x \leq \frac{\pi}{2}] then:
[latexmath]
++++
\begin{equation}
\begin{split}
\arcsin \circ \sin \triangleleft x &= x
\end{split}
\end{equation}
++++

If stem:[0 \leq x \leq \pi] then:
[latexmath]
++++
\begin{equation}
\begin{split}
\arccos \circ \cos \triangleleft x &= x
\end{split}
\end{equation}
++++
...
\begin{equation}
\begin{split}
\arctan \circ \tan \triangleleft x &= x
\end{split}
\end{equation}
++++
****
